# Hidden Valley Typography Preview
...
- Source role: `shared_brand_typography`
  ...
  Notes: The user instructed Hidden Valley to use the universal typography baseline because no brand-specific font guidance was supplied.

## Primitive Recommendations

- Proposed primitive:
  Token name: `hidden_valley/family/primary`
  Source item: `Inter`
...
- Reuse:
  ...
  Notes: No brand-specific typography guidance was supplied, so Hidden Valley keeps the universal effective typography behavior.

## Live Semantic Mapping

- `family/heading` -> `hidden_valley/family/primary`
- `family/body` -> `hidden_valley/family/primary`
- `family/action` -> `hidden_valley/family/primary`
...
- Inherited or deferred notes: Hidden Valley adds a raw brand family token only; the effective typography values stay identical to the universal baseline.
...
- Proposed family token: `hidden_valley/family/primary`
- Proposed weight token: `inherited current heading weights`
- Proposed size token: `inherited current heading ladder`
- Notes: Same effective values as universal, but through the Hidden Valley raw family alias.
...
- Hidden Valley adds a governed raw family token for brand parity, but the live typography behavior remains unchanged from the universal baseline.
...
- Subject: `Hidden Valley mirrored typography baseline`
  Channels: `web, email, ads`
  Rule: Create a raw Hidden Valley family token, but keep its effective typography values identical to the universal baseline.
