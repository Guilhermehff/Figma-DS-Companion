...
- Supersedes:
- Superseded by: `figma/decisions/2026-03-30-liberty-mountain-ramp-consolidation.md` (raw color family inventory and Liberty Mountain color documentation model only)
